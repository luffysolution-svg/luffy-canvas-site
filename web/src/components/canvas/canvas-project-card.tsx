            ...
            <div className="mt-8 flex items-end justify-between gap-3">
                ...
                <div className="flex items-center gap-1" onClick={(event) => event.stopPropagation()}>
                    {editing ? (
                        ...
                        <>
                            <Button type="text" size="small" shape="circle" icon={<Download className="size-4" />} onClick={() => void exportCanvasProjects([project], project.title || "luffy-canvas")} aria-label="导出" />
