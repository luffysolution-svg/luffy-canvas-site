---
title: Docker 部署
description: 使用 Docker Compose 部署 luffy-canvas-site
---
...
services:
  app:
    image: ghcr.io/luffysolution-svg/luffy-canvas-site:latest
    ports:
      - "3000:3000"
    environment:
...
docker run -d -p 3000:3000 \
  ...
  ghcr.io/luffysolution-svg/luffy-canvas-site:latest
```
